...
/* Forward declaration of the class GUI::GUI */
#ifndef _GUIGUI_
  EW_DECLARE_CLASS( GUIGUI )
#define _GUIGUI_
#endif
...
EW_DEFINE_FIELDS( GUIGUI, CoreRoot )
  EW_OBJECT  ( DriverInterface, DriverInterfceDriverInterface )
EW_END_OF_FIELDS( GUIGUI )

/* Virtual Method Table (VMT) for the class : 'GUI::GUI' */
EW_DEFINE_METHODS( GUIGUI, CoreRoot )
