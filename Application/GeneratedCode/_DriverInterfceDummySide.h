...
#ifndef _DriverInterfceDummySide_H
#define _DriverInterfceDummySide_H
...
/* Forward declaration of the class DriverInterfce::DummySide */
#ifndef _DriverInterfceDummySide_
  EW_DECLARE_CLASS( DriverInterfceDummySide )
#define _DriverInterfceDummySide_
#endif
...
/* Deklaration of class : 'DriverInterfce::DummySide' */
EW_DEFINE_FIELDS( DriverInterfceDummySide, CoreGroup )
  EW_OBJECT  ( ValueDisplay,    WidgetSetValueDisplay )
  EW_OBJECT  ( ValueDisplay_Fixpoint, WidgetSetValueDisplay )
  EW_OBJECT  ( Dummy_Text,      ViewsText )
  EW_OBJECT  ( VerticalSlider,  WidgetSetVerticalSlider )
  EW_OBJECT  ( Gauge,           WidgetSetGauge )
  EW_PROPERTY( Dummy,           XInt32 )
EW_END_OF_FIELDS( DriverInterfceDummySide )

/* Virtual Method Table (VMT) for the class : 'DriverInterfce::DummySide' */
EW_DEFINE_METHODS( DriverInterfceDummySide, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( DriverInterfceDummySide _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( DriverInterfceDummySide _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( DriverInterfceDummySide )
...
#endif /* _DriverInterfceDummySide_H */
