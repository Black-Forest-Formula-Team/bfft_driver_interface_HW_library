...
void BezierClockClockScreen__Init( BezierClockClockScreen _this, XObject aLink, XHandle aArg )
{
  ...
  CoreQuadView__OnSetPoint4( &_this->TouchHandlerRight, _Const001A );
  CoreQuadView__OnSetPoint3( &_this->TouchHandlerRight, _Const001B );
  CoreQuadView__OnSetPoint2( &_this->TouchHandlerRight, _Const001C );
  CoreQuadView__OnSetPoint1( &_this->TouchHandlerRight, _Const001D );
  CoreQuadView__OnSetPoint4( &_this->TouchHandlerUp, _Const001E );
  CoreQuadView__OnSetPoint3( &_this->TouchHandlerUp, _Const001F );
  CoreQuadView__OnSetPoint2( &_this->TouchHandlerUp, _Const0020 );
  CoreQuadView__OnSetPoint1( &_this->TouchHandlerUp, _Const0021 );
...
void BezierClockTimerScreen__Init( BezierClockTimerScreen _this, XObject aLink, XHandle aArg )
{
  ...
  CoreQuadView__OnSetPoint4( &_this->TouchHandlerLeft, _Const0058 );
  CoreQuadView__OnSetPoint3( &_this->TouchHandlerLeft, _Const0063 );
  CoreQuadView__OnSetPoint2( &_this->TouchHandlerLeft, _Const001C );
  CoreQuadView__OnSetPoint1( &_this->TouchHandlerLeft, _Const001D );
