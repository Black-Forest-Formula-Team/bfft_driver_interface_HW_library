...
#ifndef _DriverInterfceDriverInterface_H
#define _DriverInterfceDriverInterface_H
...
/* Forward declaration of the class DriverInterfce::DriverInterface */
#ifndef _DriverInterfceDriverInterface_
  EW_DECLARE_CLASS( DriverInterfceDriverInterface )
#define _DriverInterfceDriverInterface_
#endif
...
EW_DEFINE_METHODS( DriverInterfceDriverInterface, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( DriverInterfceDriverInterface _this, XPoint 
    aSize )
  EW_METHOD( UpdateViewState,   void )( DriverInterfceDriverInterface _this, XSet 
    aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( DriverInterfceDriverInterface )
...
#endif /* _DriverInterfceDriverInterface_H */
