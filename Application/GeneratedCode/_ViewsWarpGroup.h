...
/* 'C' function for method : 'Views::WarpGroup.OnSetOpacity4()' */
void ViewsWarpGroup_OnSetOpacity4( ViewsWarpGroup _this, XInt32 value );

/* 'C' function for method : 'Views::WarpGroup.OnSetOpacity3()' */
void ViewsWarpGroup_OnSetOpacity3( ViewsWarpGroup _this, XInt32 value );

/* 'C' function for method : 'Views::WarpGroup.OnSetOpacity2()' */
void ViewsWarpGroup_OnSetOpacity2( ViewsWarpGroup _this, XInt32 value );

/* 'C' function for method : 'Views::WarpGroup.OnSetOpacity1()' */
void ViewsWarpGroup_OnSetOpacity1( ViewsWarpGroup _this, XInt32 value );
