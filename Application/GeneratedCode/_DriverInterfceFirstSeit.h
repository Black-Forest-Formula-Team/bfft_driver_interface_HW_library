...
#ifndef _DriverInterfceFirstSeit_H
#define _DriverInterfceFirstSeit_H
...
/* Forward declaration of the class DriverInterfce::FirstSeit */
#ifndef _DriverInterfceFirstSeit_
  EW_DECLARE_CLASS( DriverInterfceFirstSeit )
#define _DriverInterfceFirstSeit_
#endif
...
/* Deklaration of class : 'DriverInterfce::FirstSeit' */
EW_DEFINE_FIELDS( DriverInterfceFirstSeit, CoreGroup )
  EW_OBJECT  ( kugel,           ViewsImage )
  EW_OBJECT  ( Strasse,         ViewsImage )
  EW_OBJECT  ( Image1,          ViewsImage )
  EW_OBJECT  ( SpeedReifen,     ViewsImage )
...
EW_DEFINE_METHODS( DriverInterfceFirstSeit, CoreGroup )
  ...
  EW_METHOD( BroadcastEvent,    XObject )( CoreGroup _this, CoreEvent aEvent, XSet 
    aFilter )
  EW_METHOD( UpdateLayout,      void )( DriverInterfceFirstSeit _this, XPoint aSize )
  EW_METHOD( UpdateViewState,   void )( DriverInterfceFirstSeit _this, XSet aState )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( DriverInterfceFirstSeit )
...
#endif /* _DriverInterfceFirstSeit_H */
