...
How to build a demo using this template for the STM32H745 Discovery board:
--------------------------------------------------------------------------

The STM32H745 target provides only a small on-chip flash memory. A small bootloader
