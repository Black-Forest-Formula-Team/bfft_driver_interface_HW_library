...
static const uint8_t cau8TxData[CAN_BUFFER_SIZE] = {0xBAu, 0xAA, 0xCA, 0xFE};
...
static int8_t s8CANGeneralInit(void)
{
   ...
   if(HAL_OK != HAL_FDCAN_ActivateNotification(&hfdcan1,FDCAN_IT_TX_FIFO_EMPTY||FDCAN_IT_TX_COMPLETE,u32CANTxBufferNumber))
   {
      s8ErrorHandle = CAN_ERROR;
   }
